...
void test_previous_data_is_used_correctly()
{
    ...
    test_process_data(packet_to_hex(cmdC6_packet1), target); // schedules the TX
    get_protocol("00")->protocol_update(&target);            // performs it
    ...
    test_process_data(packet_to_hex(cmdC6_packet2), target); // schedules the TX
    get_protocol("01")->protocol_update(&target);            // performs it
